...
version=$(grep -oE "[0-9]+[.][0-9]+[.][0-9]+" "${repo_root}internal/version/version.go")
...
sed -i "s/${version}/${new_version}/g" "${repo_root}internal/version/version.go"
git add "${repo_root}internal/version/version.go" "${repo_root}/Dockerfile"
